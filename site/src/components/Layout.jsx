      ...
      <footer className="py-12">
        <div className="container flex items-center justify-between text-gray-400 text-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://wa.me/917678609018?text=Hi%20I%20am%20interested%20in%20your%20video%20editing%20services" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="hover:opacity-80 transition-opacity">
              <img src="/assets/icons/whatsapp.png" alt="WhatsApp" width="18" height="18" />
            </a>
